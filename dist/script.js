...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function checkEmailInputs() {
      this.emailInputs.forEach(function (input) {
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          messageStatus.textContent = _this.messages.loading;
          form.parentNode.appendChild(messageStatus);
          var formData = new FormData(form);

          _this.postData(_this.path, formData).then(function (response) {
            console.log(response);
            messageStatus.textContent = _this.messages.success;
          }).catch(function () {
            messageStatus.textContent = _this.messages.failure;
          }).finally(function () {
            _this.clearInputs();
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    key: "createEvents",
    value: function createEvents(selector, event) {
      var _this5 = this;
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function onPlayerStateChange(event) {
      try {
        ...
        var playElem = this.activeBtn.querySelector('svg').cloneNode(true);
